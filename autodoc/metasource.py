...
class MetaDatabase:
    ...
    def __init__(self, database_id: int, manager: DatabaseManager):
        """Initialise a metadatabase from details in the MetaDatabaseSource table."""
        self.database_id = database_id
        self.details = manager.get_meta_database_details(database_id=database_id).data
        self.engine = create_engine(self.details["ConnectionString"])
